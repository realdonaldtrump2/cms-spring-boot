...
public class ArticleTagSo implements Serializable {
    ...
    public ArticleTagSo(String title, Integer pageSize, Integer pageNum, Date createDatetimeStart, Date createDatetimeEnd, Date updateDatetimeStart, Date updateDatetimeEnd) {
        this.title = title;
        this.pageSize = pageSize;
        this.pageNum = pageNum;
        this.createDatetimeStart = createDatetimeStart;
